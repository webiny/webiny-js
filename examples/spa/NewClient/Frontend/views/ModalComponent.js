...
import { app, createComponent, isElementOfType } from 'webiny-client';
...
class ModalComponent extends React.Component {
    ...
    prepareChild(child) {
        ...
        if (_.find([Header, Body, Footer], c => isElementOfType(child, c))) {
            const props = { dialog: this };
            if (isElementOfType(child, Header) && child.props.onClose === _.noop) {
            ...
            <div style={_.merge({}, { display: 'block' }, this.props.style)}>
                ...
                <div className={className} tabIndex="-1" style={{ display: 'block' }} data-role="modal">
                    <Animate
                        ...
                        <div className={classSet(styles.dialog, styles.show, this.props.className)}
                             style={{ top: -50 }}
                             data-role="dialog">
