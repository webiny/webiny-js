...
class PagePublishedEvent extends DomainEvent<PagePublishedPayload> {
...
export const PagePublishedHandler =
  createAbstraction<IEventHandler<PagePublishedEvent>>("PagePublishedHandler");

export namespace PagePublishedHandler {
  export type Interface = IEventHandler<DomainEvent<PagePublishedEvent>>;
}
...
export const UserRegisteredHandler =
  createAbstraction<IEventHandler<UserRegisteredEvent>>("UserRegisteredHandler");

export namespace UserRegisteredHandler {
  export type Interface = IEventHandler<DomainEvent<UserRegisteredEvent>>;
}
...
export const OrderPlacedHandler =
  createAbstraction<IEventHandler<OrderPlacedEvent>>("OrderPlacedHandler");

export namespace OrderPlacedHandler {
  export type Interface = IEventHandler<DomainEvent<OrderPlacedEvent>>;
}
