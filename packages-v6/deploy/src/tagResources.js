...
function tagResources(tags) {
    pulumi.runtime.registerStackTransformation(function (args) {
        if (isTaggable(args.type)) {
            args.props["tags"] = __assign(__assign({}, args.props["tags"]), tags);
