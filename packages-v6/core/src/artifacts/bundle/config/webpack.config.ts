...
interface CreateWebpackConfig {
    (webpackEnv: string, params: CreateWebpackConfigParams): webpack.Configuration;
}
    ...
    return {
        ...
        optimization: {
            ...
            minimizer: [
                ...
                // @ts-ignore Ignoring this due to type mismatch. No time to dig into this right now.
