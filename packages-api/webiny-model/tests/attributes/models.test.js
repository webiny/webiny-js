...
describe('attribute models test', function () {
    ...
    it('should pass - valid data sent', async () => {
        model.attribute1 = [{name: 'Enlai', type: 'dog'}, {name: 'Rocky', type: 'dog'}, {name: 'Lina', type: 'parrot'}];
        model.attribute2 = [{firstName: 'John', lastName: 'Doe'}, {firstName: 'Jane', lastName: 'Doe'}];
        await model.validate();
    });

    it('should fail - all good except last item of attribute1', async () => {
        model.attribute1 = [{name: 'Enlai', type: 'dog'}, {name: 'Rocky', type: 'dog'}, {name: 'Lina', type: 'bird'}];
        model.attribute2 = [{firstName: 'John', lastName: 'Doe'}, {firstName: 'Jane', lastName: 'Doe'}];
