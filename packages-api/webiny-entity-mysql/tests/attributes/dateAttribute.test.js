...
describe("date attribute test", function() {
    it("it must return YYYY-MM-DD hh:mm:ss format when sending Date to storage", async () => {
    ...
    it("it must populate the attribute correctly using date string", async () => {
        const entity = new DateEntity();
    ...
    it("it must populate the attribute correctly using Date object", async () => {
        const entity = new DateEntity();
