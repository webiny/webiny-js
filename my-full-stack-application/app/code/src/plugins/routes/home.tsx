            ...
            <div className={"splash"}>
                ...
                <ul>
                    <UsefulLink url={"/docs/#"} title={"Create Custom Application Tutorial"}>
                        Learn how to create a completely custom application that&apos;s interacting
                        with a standalone GraphQL API.
                    </UsefulLink>
                    <UsefulLink url={"/docs/#"} title={"The New React Application Scaffold"}>
                        Learn more about the New React Application scaffold that was used to create
                    ...
                    >
                        Learn how to deploy your Webiny project and its project applications, using
                        the Webiny CLI.
                    </UsefulLink>
                    <UsefulLink
