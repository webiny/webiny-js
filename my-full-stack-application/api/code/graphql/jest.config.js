...
if (TEST_TYPE !== "unit") {
    log.info(`${log.info.hl("my-full-stack-application/api/code/graphql")}: Assigning environment variables...`);
    const stackOutput = getStackOutput({ folder: "my-full-stack-application/api", env: DEPLOY_ENVIRONMENT });
