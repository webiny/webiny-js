declare module "@rmwc/base/foundation-component.tsx" {
    ...
    export  class FoundationComponent<Foundation extends any, P, S extends any = {}> extends React.Component<FoundationPropsT<P>, FoundationStateT<S>> {
        ...
        createElement<ElementType extends HTMLElement = HTMLElement>(elementName: string): FoundationElement<ExtractProps<ElementType>, ElementType>;
        update(): void;
