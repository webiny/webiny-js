 ...
 */
var AddServiceModal = (function(_Webiny$Ui$ModalCompo) {
    (0, _inherits3.default)(AddServiceModal, _Webiny$Ui$ModalCompo);

    function AddServiceModal() {
        (0, _classCallCheck3.default)(this, AddServiceModal);

        var _this = (0, _possibleConstructorReturn3.default)(
            this,
            (AddServiceModal.__proto__ || Object.getPrototypeOf(AddServiceModal)).call(this)
        );

        _this.api = new _webinyClient.Webiny.Api.Endpoint("/services/webiny/services");
        return _this;
    }

    (0, _createClass3.default)(AddServiceModal, [
        {
            key: "renderDialog",
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(Select, {
                                                ...
                                                placeholder: _this2.i18n("Select service..."),
                                                name: "service",
                                                validate: "required",
...
AddServiceModal.defaultProps = _lodash2.default.assign(
    {},
...
exports.default = _webinyClient.Webiny.createComponent(AddServiceModal, {
    modules: ["Modal", "Form", "Grid", "Select", "Button"]
});
//# sourceMappingURL=AddServiceModal.js.map
