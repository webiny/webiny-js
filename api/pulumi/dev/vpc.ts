...
export class Vpc {
    ...
    public getFunctionVpcConfig(): aws.lambda.FunctionArgs["vpcConfig"] {
        return {
            subnetIds: this.subnets.private.map(subNet => subNet.id),
            securityGroupIds: [this.vpc.defaultSecurityGroupId]
        };
    }
}
