 ...
 * - `type` is the folder type. Build it with `FlpFactory.FolderType` — `files()` for File Manager,
 *   `cmsEntries(modelId)` for a Headless CMS model. Apps that register their own folders can pass
 *   that type as a plain string instead.
        ...
        return [
            {
                ...
                type: FlpFactory.FolderType.cmsEntries("article"),
                path: "/marketing/*",
            ...
            },
            {
                ...
                type: FlpFactory.FolderType.files(),
                path: "/brand-assets/*",
                permissions: [{ team: "content-team", level: "viewer" }]
            },
            {
