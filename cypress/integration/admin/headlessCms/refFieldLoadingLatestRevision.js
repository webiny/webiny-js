...
context("Headless CMS - Smoke Test", () => {
    ...
    it("should be able to create models and then entries", () => {
        ...
        cy.visit("/cms/content-models");
        cy.findByTestId("new-record-button").click();
        cy.findByTestId("cms-new-content-model-modal")
            .within(() => {
                cy.findByText("Ungrouped")
                    .findByLabelText("Name")
                    .type(newModel2)
        ...
        cy.findByTestId("cms-editor-edit-fields-dialog")
            .within(() => {
        ...
        //     .click()
        //     .findByText("A new revision was created!")
        //     .should("exist")
        ...
        // Successfully published revision #14!
