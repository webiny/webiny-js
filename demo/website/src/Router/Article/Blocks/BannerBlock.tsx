        ...
        <section className="bg-purple-50 rounded p-5 my-10">
            ...
            <img className="rounded-full w-15 h-auto" src={block.image} alt="dashboard image"/>
                <div className="mt-4 md:mt-0">
                    <h3 className="mb-4 text-3xl tracking-tight font-extrabold text-purple-800 dark:text-white">{block.title}</h3>
                    <a href={block.actionUrl} className="inline-flex items-center text-white bg-purple-500 hover:bg-purple-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                        {block.actionLabel}
