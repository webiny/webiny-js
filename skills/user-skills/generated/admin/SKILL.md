...
**Import:** `import { createPermissionsAbstraction } from "webiny/admin"`
**Source:** `@webiny/app-admin/permissions/index.ts`
...
**Import:** `import { createPermissionsFeature } from "webiny/admin"`
**Source:** `@webiny/app-admin/permissions/index.ts`
...
**Name:** `Permissions`
**Kind:** type
**Import:** `import type { Permissions } from "webiny/admin"`
