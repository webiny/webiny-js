 ...
 * @param {any} parameters This is the array of values to search in. It is passed as a validator parameter: `in:1:2:3`. Array values are separated by `:`.
...
export default (value: any, parameters: Array<any>) => {
    if (!value) return;
    value = value + "";
