...
class DefaultColumnsContainer extends ColumnsContainer {
    ...
    bigInt(): BigIntColumn {
        ...
        table.setColumn(this.name, new BigIntColumn(this.name, this));
    ...
    decimal(): DecimalColumn {
        const table = this.getParentTable();
        table.setColumn(this.name, new DecimalColumn(this.name, this));
        return table.getColumn(this.name);
    }

    double(): DoubleColumn {
        const table = this.getParentTable();
        table.setColumn(this.name, new DoubleColumn(this.name, this));
        return table.getColumn(this.name);
    }

    enum(): EnumColumn {
        const table = this.getParentTable();
        table.setColumn(this.name, new EnumColumn(this.name, this));
        return table.getColumn(this.name);
    }

    float(): FloatColumn {
        const table = this.getParentTable();
        table.setColumn(this.name, new FloatColumn(this.name, this));
        return table.getColumn(this.name);
    }
    ...
    mediumInt(): MediumIntColumn {
        const table = this.getParentTable();
        table.setColumn(this.name, new MediumIntColumn(this.name, this));
        return table.getColumn(this.name);
    }
    ...
    smallInt(): SmallIntColumn {
        const table = this.getParentTable();
        table.setColumn(this.name, new SmallIntColumn(this.name, this));
        return table.getColumn(this.name);
    }
    ...
    tinyInt(): TinyIntColumn {
        const table = this.getParentTable();
        table.setColumn(this.name, new TinyIntColumn(this.name, this));
        return table.getColumn(this.name);
    }
    ...
    varChar(width: number): VarCharColumn {
        const table = this.getParentTable();
        table.setColumn(this.name, new VarCharColumn(this.name, this, width));
        return table.getColumn(this.name);
    }
    year(): YearColumn {
        const table = this.getParentTable();
