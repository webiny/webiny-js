...
class Base {
    ...
    get(url = "", body = {}, config = {}) {
        return Http.get(this.fullUrl(url), body, config)
            .then(handleResponse)
            .catch(handleResponse);
    }

    delete(url = "", config = {}) {
        return Http.delete(this.fullUrl(url), config)
            .then(handleResponse)
            .catch(handleResponse);
    }

    head(url = "", config = {}) {
        return Http.head(this.fullUrl(url), config)
            .then(handleResponse)
            .catch(handleResponse);
    }

    post(url = "", body = {}, query = {}, config = {}) {
        return Http.post(this.fullUrl(url), body, query, config)
            .then(handleResponse)
            .catch(handleResponse);
    }

    put(url = "", body = {}, query = {}, config = {}) {
        return Http.put(this.fullUrl(url), body, query, config)
            .then(handleResponse)
            .catch(handleResponse);
    }

    patch(url = "", body = {}, query = {}, config = {}) {
        return Http.patch(this.fullUrl(url), body, query, config)
            .then(handleResponse)
            .catch(handleResponse);
    }
