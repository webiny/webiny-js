...
export default {
    ...
    N: [undefined, 'ISO-8601 numeric representation of the day of the week (added in PHP 5.1.0)', '1 (for Monday) through 7 (for Sunday)'],
...
// Week	---	---
    W: [undefined, 'ISO-8601 week number of year, weeks starting on Monday', 'Example: 42 (the 42nd week in the year)'],
// ['/ Month	---	---
...
// Timezone	---	---
    e: [undefined, 'Timezone identifier (added in PHP 5.1.0)', 'Examples: UTC, GMT, Atlantic/Azores'],
    I: [undefined, '(capital i) Whether or not the date is in daylight saving time	', '1 if Daylight Saving Time, 0 otherwise.'],
    O: ['ZZ', 'Difference to Greenwich time (GMT) in hours', 'Example: +0200'],
    P: [undefined, 'Difference to Greenwich time (GMT) with colon between hours and minutes (added in PHP 5.1.3)', 'Example: +02:00'],
    T: [undefined, 'Timezone abbreviation', 'Examples: EST, MDT ...'],
    Z: [undefined, 'Timezone offset in seconds. The offset for timezones west of UTC is always negative, and for those east of UTC is always positive.	', '-43200 through 50400'],
// Full Date/Time	---	---
