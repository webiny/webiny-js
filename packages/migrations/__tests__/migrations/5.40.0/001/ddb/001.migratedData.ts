import { createFormsData } from "~tests/migrations/5.40.0/001/ddb/001.data";
...
export const createMigratedFormSubmissionsData = () => {
    ...
    for (const form of forms) {
        for (let i = 0; i < form.stats.submissions; i++) {
            ...
            const revision = {
                PK: `T#${form.tenant}#L#${form.locale}#CMS#CME#CME#${form.id}-submission-${i}`,
                SK: "REV#0001",
                GSI1_PK: `T#${form.tenant}#L#${form.locale}#CMS#CME#M#fbSubmission#A`,
                GSI1_SK: `${form.id}-submission-${i}#0001`,
                TYPE: "cms.entry",
                ...commonFields
            };
            ...
            const latest = {
                PK: `T#${form.tenant}#L#${form.locale}#CMS#CME#CME#${form.id}-submission-${i}`,
                SK: "L",
                GSI1_PK: `T#${form.tenant}#L#${form.locale}#CMS#CME#M#fbSubmission#L`,
                GSI1_SK: `${form.id}-submission-${i}#0001`,
                TYPE: "cms.entry.l",
                ...commonFields
            };
