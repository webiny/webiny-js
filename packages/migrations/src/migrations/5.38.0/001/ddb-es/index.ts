...
import { getDecompressedData } from "~/migrations/5.38.0/001/utils/getDecompressedData";
import { getCompressedData } from "~/migrations/5.38.0/001/utils/getCompressedData";
...
interface RestoreOriginalElasticsearchSettingsParams {
    migrationStatus: MultiStepFormsDataMigrationCheckpoint;
    logger: Logger;
}
    ...
    implements DataMigration<MultiStepFormsDataMigrationCheckpoint>
{
    ...
    public constructor(table: Table, esTable: Table, elasticsearchClient: Client) {
    ...
    async execute({
        ...
        const migrationStatus =
            context.checkpoint || ({} as MultiStepFormsDataMigrationCheckpoint);
