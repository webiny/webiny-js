        ...
        await forEachTenantLocale({
            ...
            callback: async ({ tenantId, localeCode }) => {
                ...
                try {
                    ...
                    // Let's create the published entry for each form found
                    for (const formId of uniqueFormIds) {
                        ...
                        // No form published form entry found: we don't need to create an HCMS entry for it
                        if (!form) {
                            continue;
                        }
                    ...
                    logger.info(`Migrated form published entries for ${tenantId} - ${localeCode}.`);
                } finally {
