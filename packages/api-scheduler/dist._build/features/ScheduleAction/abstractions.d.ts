...
import { InvalidScheduleDateError, ScheduledActionPersistenceError, SchedulerServiceError, NamespaceHandlerNotFoundError } from "~/domain/errors.js";
...
export interface IScheduleActionUseCase {
    execute<T extends GenericRecord>(params: IScheduleActionParams): Promise<Result<IScheduledAction<T>, ScheduleActionError>>;
}
