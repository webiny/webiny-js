...
import { NotAuthorizedError, ScheduledActionNotFoundError, ScheduledActionPersistenceError, SchedulerServiceError } from "~/domain/errors.js";
/**
...
export interface ICancelScheduledActionUseCase {
    execute(params: ICancelScheduledActionUseCaseParams): Promise<Result<boolean, CancelScheduledActionError>>;
}
