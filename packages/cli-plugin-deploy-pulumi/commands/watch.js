...
const { getRandomColorForString, loadEnvVariables, runHook } = require("../utils");
...
module.exports = async (inputs, context) => {
    ...
    client.on("message", async (_, message) => {
        ...
        if (payload.eventType !== "webiny.watch.functionInvocation") {
            return;
        }
        ...
        try {
            ...
            await client.publish(
                IOT_ENDPOINT_TOPIC,
                JSON.stringify({
                    eventType: "webiny.watch.functionInvocationResult",
