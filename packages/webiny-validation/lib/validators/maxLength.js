...
exports.default = (value, params) => {
    ...
    if (_lodash2.default.isString(value)) {
        throw new _validationError2.default("Value requires " + params[0] + " characters at most.");
    }
    throw new _validationError2.default("Value requires " + params[0] + " items at most.");
};
