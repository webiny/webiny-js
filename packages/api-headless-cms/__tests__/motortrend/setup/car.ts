export const createCarData = () => {
    return {
        ...
        vehicleRankingClass: [
            {
                ...
                classThumbnailUrl:
                    "https://www.motortrend.com/uploads/sites/5/2020/12/sports-car-a.png",
                associatedBody: 0,
                topRankingTrophyImage:
                    "https://www.motortrend.com/uploads/sites/5/2020/06/trophie-1.svg",
                isRankingSubclass: 1,
                classThumbnailRolloverUrl:
                    "https://www.motortrend.com/uploads/sites/5/2020/12/sports-car-b.png",
                bestClassImageUrl:
                    "https://www.motortrend.com/uploads/sites/5/2021/04/Best-Sports-Cars.jpg",
            ...
            },
            {
                ...
                classThumbnailUrl:
                    "https://www.motortrend.com/uploads/sites/5/2020/12/convertible-a.png",
                associatedBody: 1,
                topRankingTrophyImage:
                    "https://www.motortrend.com/uploads/sites/5/2020/06/trophie-1.svg",
                isRankingSubclass: 1,
                classThumbnailRolloverUrl:
                    "https://www.motortrend.com/uploads/sites/5/2020/12/convertible-b.png",
                bestClassImageUrl:
                    "https://www.motortrend.com/uploads/sites/5/2021/04/Best-Convertibles-1.jpg",
                isMakeBodyStyleVehicleShow: 1
            }
        ],
        warranty: {
        ...
        carsRebates: [
            {
                ...
                rebatesHigh: 500,
                rebateText:
                    "Mazda announces a Bonus Cash offer for active duty Military personnel.",
        ...
        carMatchMotortrendRankings: [
            {
                ...
                winnerDescription:
                    "Based on your answers, we think you and the Mazda Miata may be compatible.",
                rankWithinSubclass: 1,
        ...
        cpoProgram: {
            ...
            cpoWarranty:
                "If purchased before end of new car warranty then coverage is 48 months/48,000 miles on covered components from original in-service date; if purchased after end of new car warranty then coverage is 12 months/12,000 miles. All vehicles receive an 84-month/100,000-mile limited powertrain warranty from original in-service date.",
            cpoWarrantyDeductible: "No",
            cpoWarrantyBbnc:
                "The CPO warranty adds 24 months/40,000 miles to the new-car powertrain warranty and a 12-month/12,000-mile additional limited warranty.",
            cpoWarrantyTransferable: "Yes",
            cpoWarrantyExtended:
                "Available Mazda Prepaid Maintenance and Extended Confidence plans with various terms and mileage intervals",
            ...
            cpoAdditionalBenefits:
                "AutoCheck vehicle history report with 3-year Buyback Protection from Experian, and complimentary 3-month subscription to SiriusXM on equipped vehicles.",
            cpoProgramOverview:
