...
describe("object storage converter - single object with multiple nested objects with json child", () => {
    ...
    it("should convert multiple nested objects with json child to and from storage", async () => {
