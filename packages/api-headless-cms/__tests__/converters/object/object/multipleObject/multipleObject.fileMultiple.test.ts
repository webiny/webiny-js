...
describe("object storage converter - single object with multiple nested objects with multiple file child", () => {
    ...
    it("should convert multiple nested objects with multiple file child to and from storage", async () => {
