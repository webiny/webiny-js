...
describe("object storage converter - single object with multiple nested objects with multiple datetime child", () => {
    ...
    it("should convert multiple nested objects with multiple datetime child to and from storage", async () => {
