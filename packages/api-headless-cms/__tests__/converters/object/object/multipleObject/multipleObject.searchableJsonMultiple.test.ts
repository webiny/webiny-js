...
describe("object storage converter - single object with multiple nested objects with multiple searchable-json child", () => {
    ...
    it("should convert multiple nested objects with multiple searchable-json child to and from storage", async () => {
