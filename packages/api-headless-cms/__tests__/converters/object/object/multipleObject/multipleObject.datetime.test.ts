...
describe("object storage converter - single object with multiple nested objects with datetime child", () => {
    ...
    it("should convert multiple nested objects with datetime child to and from storage", async () => {
