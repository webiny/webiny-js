...
describe("object storage converter - single object with dynamic zone with multiple long-text template", () => {
    ...
    it("should convert single object with dynamic zone with multiple long-text template to and from storage", async () => {
