...
describe("object storage converter - multiple objects with single nested object with file child", () => {
    ...
    it("should convert multiple objects with single nested object with file child to and from storage", async () => {
