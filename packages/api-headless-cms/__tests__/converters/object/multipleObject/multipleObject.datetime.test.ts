...
describe("object storage converter - multiple objects with single datetime child", () => {
    ...
    it("should convert multiple objects with single datetime child to and from storage", async () => {
