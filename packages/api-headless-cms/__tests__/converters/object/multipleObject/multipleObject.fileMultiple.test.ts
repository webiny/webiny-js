...
describe("object storage converter - multiple objects with multiple file child", () => {
    ...
    it("should convert multiple objects with multiple file child to and from storage", async () => {
