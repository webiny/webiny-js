...
describe("dynamicZone storage converter - single dynamic zone with multiple rich-text template", () => {
    ...
    it("should convert single dynamic zone with multiple rich-text template to and from storage", async () => {
