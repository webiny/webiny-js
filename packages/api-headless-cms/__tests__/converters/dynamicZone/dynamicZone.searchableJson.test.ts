...
describe("dynamicZone storage converter - single dynamic zone with searchable-json template", () => {
    ...
    it("should convert single dynamic zone with searchable-json template to and from storage", async () => {
