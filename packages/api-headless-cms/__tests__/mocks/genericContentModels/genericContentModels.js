...
import { CONTENT_MODEL_GROUP_ID } from "@webiny/api-headless-cms/testing/createContentModelGroup";

export default ({ contentModelGroupId } = {}) => [
    {
        name: "Category",
        description: "Product category",
        modelId: "category",
        group: contentModelGroupId || CONTENT_MODEL_GROUP_ID,
