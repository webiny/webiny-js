...
import { GetRevisionByIdUseCase } from "~/features/contentEntries/GetRevisionById/abstractions.js";
import type {
    CmsEntry,
    CmsModel,
    UpdateCmsEntryInput,
...
import { EntryLockedError } from "~/domains/contentEntries/errors.js";
