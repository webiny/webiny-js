...
// Wrapped in a holder so DI treats it as a single value, not a multiple-binding of SecurityPermission.
export interface TestPermissionsHolder {
    list: SecurityPermission[];
}

export const TestPermissions = new Abstraction<TestPermissionsHolder>("CmsTestPermissions");
