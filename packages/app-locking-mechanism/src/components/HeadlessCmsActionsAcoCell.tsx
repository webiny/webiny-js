...
const LockingMechanismCellActions = CellActions.createDecorator(Original => {
    return function LockingMechanismCellActions(props) {
        const { getLockRecordEntry, isRecordLocked } = useLockingMechanism();
