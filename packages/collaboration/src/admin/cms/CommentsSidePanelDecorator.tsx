...
import { useCommentsPresenter } from "~/admin/presentation/comments/useComments.js";
import { CommentsPanel } from "~/admin/presentation/comments/components/CommentsPanel.js";
import { CommentMarkersProvider } from "~/admin/cms/CommentMarkersContext.js";
import { collectItemLocators } from "~/admin/cms/listItemLocators.js";
import { buildLocatorLabel } from "~/admin/cms/fieldLabels.js";
import { cmsContentId, COLLAB_THREAD_PARAM, COLLAB_FIELD_PARAM } from "~/admin/constants.js";

export const CommentsSidePanelDecorator = ContentEntryFormContent.createDecorator(Original => {
    return createReactiveComponent(function CommentsSidePanelDecoratorInner(props) {
