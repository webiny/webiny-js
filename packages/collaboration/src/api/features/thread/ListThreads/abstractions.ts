...
import type { CollabThreadType, ICollabThread } from "~/api/domain/thread/abstractions.js";
import type { CollabThreadPersistenceError } from "~/api/domain/thread/errors.js";
