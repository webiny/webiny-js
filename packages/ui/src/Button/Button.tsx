 ...
 */
export const ButtonDefault: React.VFC<ButtonProps> = props => {
 ...
 */
export const ButtonPrimary: React.VFC<ButtonProps> = props => {
    const {
        disabled,
        onClick,
        children,
 ...
 */
export const ButtonSecondary: React.VFC<ButtonProps> = props => {
    const {
        disabled,
        onClick,
        children,
 ...
 */
export const ButtonFloating: React.VFC<ButtonFloatingProps> = props => {
    const {
        disabled,
        label,
        icon,
 ...
 */
export const ButtonIcon: React.VFC<IconProps> = props => <Icon {...props} />;
