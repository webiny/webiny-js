 ...
 *
 * The composition root lives in @webiny/api-event-handler-server-sql (`createSqliteApiHandler`) —
...
export const handler = createSqliteApiHandler({ extensions, knex: createSqliteConnection() });
