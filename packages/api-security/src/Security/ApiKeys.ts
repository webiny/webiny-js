...
export class ApiKeys {
    protected storage: ApiKeyStorageOperations;
    ...
    setStorageOperations(storageFactory: ApiKeyStorageOperationsFactory) {
    ...
    async getApiKeyByToken(token) {
        try {
            return await this.storage.getByToken({
                token
            });
        } catch (ex) {
    ...
    async getApiKey(id) {
        ...
        const permission = await this.security.getPermission<ApiKeyPermission>("security.apiKey");
