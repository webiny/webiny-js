...
import { AfterLoginHandler } from "~/features/authentication/index.js";
import { AuthenticationContext } from "~/features/authentication/index.js";
...
class SetIdTokenCookieImpl implements AfterLoginHandler.Interface {
    constructor(
