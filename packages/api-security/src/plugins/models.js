...
export default () => ({
    ...
    apply(context) {
        ...
        const SecurityRole = securityRole({ context, createBase });
        const SecurityRoles2Models = securityRoles2Models({ context, createBase, SecurityRole });
        ...
        const SecurityGroups2Models = securityGroups2Models({ context, createBase, SecurityGroup });
