import { SchedulePublishRedirectUseCase as UseCaseAbstraction } from "./abstractions.js";
import {
...
class SchedulePublishRedirectUseCaseImpl implements UseCaseAbstraction.Interface {
...
export const SchedulePublishRedirectUseCase = UseCaseAbstraction.createImplementation({
    implementation: SchedulePublishRedirectUseCaseImpl,
