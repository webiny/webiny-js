...
const FormSubmissionsList = ({ form }: Props) => {
    const {
        loading,
        refresh,
        submissions,
    ...
    return (
        <>
            <Block title="Submissions">
                <button disabled={!hasPreviousPage} onClick={previousPage}>- Prev page</button>
                <button disabled={!hasNextPage} onClick={nextPage}>Next page +</button>
                <DataList
                    loading={loading}
                    refresh={refresh}
                    data={submissions}
                    ...
                    sorters={sorters}
                    showOptions={{ multiSelectAll: false, sorters: true, refresh: true }}
                >
                    {({ data = [] }) => (
                        <List>
                            {data.map(submission => {
