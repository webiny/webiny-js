...
import ConditionalGroupField from "../ConditionalGroupField";
import {
    rowHandle,
    fieldHandle,
    fieldContainer,
...
export const FormStep = ({
    ...
    const isStepRulesValid = formStep.rules.every(rule => rule.isValid);
                    ...
                    actions={
                        <AccordionItem.Actions>
                            {formStep.rules.length ? (
                                <StepRulesTag isValid={isStepRulesValid}>
                                    {isStepRulesValid ? "Rules Attached" : "Rules are broken"}
                                </StepRulesTag>
                            ) : (
                                <></>
                            )}
