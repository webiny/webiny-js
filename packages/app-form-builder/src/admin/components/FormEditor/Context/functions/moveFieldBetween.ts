...
/*
    ...
    * When we move field between step and condition group we are going to change property "layout" of step and the property "layout" of the Condition Group
    * When we move field between condition groups we are going to change property "layout" of those condition groups and we don't need information about steps in which those
