...
export const CreateNotificationRepository = createAbstraction<ICreateNotificationRepository>(
    "CreateNotificationRepository"
);

export namespace CreateNotificationRepository {
    export type Interface = ICreateNotificationRepository;
    export type Return = Promise<Result<INotification, NotificationPersistenceError>>;
}
