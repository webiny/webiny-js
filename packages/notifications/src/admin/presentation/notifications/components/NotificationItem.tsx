...
import type { Notification, NotificationLink, NotificationType } from "~/admin/types.js";
...
export const NotificationItem = createReactiveComponent(({ presenter, notification }: Props) => {
