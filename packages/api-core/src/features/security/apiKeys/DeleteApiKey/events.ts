...
export const ApiKeyBeforeDeleteEventHandler = createAbstraction<IEventHandler<ApiKeyBeforeDeleteEvent>>(
...
export const ApiKeyAfterDeleteEventHandler = createAbstraction<IEventHandler<ApiKeyAfterDeleteEvent>>(
