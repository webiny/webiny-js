import { getWcpProjectEnvironment } from "@webiny/wcp";
import type { WcpProjectEnvironment } from "@webiny/wcp/types.js";
 ...
 */
export function resolveWcpProjectEnvironment(): WcpProjectEnvironment | null {
