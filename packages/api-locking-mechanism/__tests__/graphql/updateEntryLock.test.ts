...
describe("update entry lock", () => {
    ...
    it("should update the lock record", async () => {
        ...
        const initialLockedOn = lockResult.data.lockingMechanism.lockEntry.data!.lockedOn;
        const initialUpdatedOn = lockResult.data.lockingMechanism.lockEntry.data!.updatedOn;
        ...
        const updatedOn = result.data.lockingMechanism.updateEntryLock.data!.updatedOn;
