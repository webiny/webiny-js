...
import type { CmsEntryMeta, CmsModel, HeadlessCms } from "@webiny/api-headless-cms/types/index.js";
...
describe("ScheduleFetcher", () => {
    ...
    const scheduleModel: CmsModel = { modelId: "scheduleModel", titleFieldId: "title" } as any;
