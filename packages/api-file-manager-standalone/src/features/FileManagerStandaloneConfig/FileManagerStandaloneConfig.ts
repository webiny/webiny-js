...
import { FileManagerStandaloneConfig as FileManagerStandaloneConfigAbstraction } from "./abstractions.js";

class FileManagerStandaloneConfigImpl implements FileManagerStandaloneConfigAbstraction.Interface {
    ...
    constructor(buildParams: BuildParams.Interface) {
        ...
        // than in FileManagerStandaloneFeature.register(): build params like WEBINY_LOCAL_STORAGE_PATH are
...
export const FileManagerStandaloneConfig =
    FileManagerStandaloneConfigAbstraction.createImplementation({
        implementation: FileManagerStandaloneConfigImpl,
