...
import type { FileManagerStandaloneConfig } from "~/features/FileManagerStandaloneConfig/abstractions.js";
...
export const makeConfig = (): FileManagerStandaloneConfig.Interface => ({
