...
class DdbEsGetEntryImpl implements GetEntryStorageOperation.Interface {
    constructor(
...
export const DdbEsGetEntry = GetEntryStorageOperation.createImplementation({
    implementation: DdbEsGetEntryImpl,
