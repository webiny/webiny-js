...
/**
 * Per-request real-time transport for the standalone server: registers `ServerWebsocketsTransport`,
 ...
 * `transports` wiring reads uniformly (`WebsocketsStandaloneFeature.register(c)`).
 */
export const WebsocketsStandaloneFeature = createFeature({
