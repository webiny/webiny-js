...
const HelperMessage = props => {
    return (
        <div
            className={
                "webiny-cognito-view__helper-text" +
                (props.isValid === false ? " webiny-cognito-view__helper-text--error" : "")
            }
        >
...
function Input(props) {
    ...
    return (
        <div className="webiny-cognito-view__input">
            <label className="webiny-cognito-view__label">
            ...
            <input
                ...
                type={props.type}
                className="webiny-cognito-view__input"
            />
            <HelperMessage
