...
const HasContentEntryPermissions: React.VFC<HasContentEntryPermissionsProps> = ({
    group,
    contentModel,
    children
}) => {
...
const Icon: React.VFC<IconProps> = ({ group }) => {
    return (
        <FontAwesomeIcon
...
export const ContentGroupsMenuItems: React.VFC = () => {
