    ...
    return (
        <>
            ...
            <div className={"wby-space-y-6"}>
                ...
                <div
                    className={
                        "wby-grid wby-grid-cols-2 wby-gap-6 wby-pb-4 wby-border-b wby-border-gray-200"
                    }
                >
                    <div className={"wby-space-y-2"}>
                        ...
                        <div className={"wby-text-md wby-text-gray-600"}>
                            <div>
                                <strong>Title:</strong> {revision1.meta.title || "N/A"}
                            </div>
                            <div>
                                <strong>Status:</strong> {revision1.meta.status}
                            </div>
                            <div>
                                <strong>Modified by:</strong>{" "}
                                {revision1.revisionCreatedBy?.displayName || "N/A"}
                            </div>
                            <div>
                                <strong>Modified on:</strong>{" "}
                                <Date date={revision1.revisionSavedOn} />
                            </div>
                        </div>
                    </div>
                    <div className={"wby-space-y-2"}>
                        ...
                        <div className={"wby-text-md wby-text-gray-600"}>
                            <div>
                                <strong>Title:</strong> {revision2.meta.title || "N/A"}
                            </div>
                            <div>
                                <strong>Status:</strong> {revision2.meta.status}
                            </div>
                            <div>
                                <strong>Modified by:</strong>{" "}
                                {revision2.revisionCreatedBy?.displayName || "N/A"}
                            </div>
                            <div>
                                <strong>Modified on:</strong>{" "}
                                <Date date={revision2.revisionSavedOn} />
                            </div>
                        </div>
                    </div>
                </div>
