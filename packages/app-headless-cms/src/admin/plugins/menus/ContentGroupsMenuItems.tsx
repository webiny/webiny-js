...
import { NothingToShowElement } from "~/admin/plugins/menus/NothingToShowElement";
    ...
    async function createMenuItems() {
        ...
        for (const group of groups) {
            ...
            const groupMenuItem = mainMenu.addElement(
                new NavigationMenuElement(`cms-content-models-${group.id}`, {
                    label: group.name,
                    icon: (
                        <FontAwesomeIcon
            ...
            group.contentModels.forEach(contentModel => {
                if (canReadEntries({ contentModelGroup: group, contentModel })) {
                    groupMenuItem.addElement(
                        new NavigationMenuElement(contentModel.modelId, {
