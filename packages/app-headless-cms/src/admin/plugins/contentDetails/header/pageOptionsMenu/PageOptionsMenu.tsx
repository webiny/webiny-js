...
const PageOptionsMenu = props => {
    ...
    return (
        <Menu
            ...
            handle={
                <IconButton
                    data-testid="cms-content-details-header-page-options-menu"
        ...
        >
            {page.locked ? (
                <MenuItem onClick={() => window.open(getPageUrl(page), target)}>
                    <ListItemGraphic>
                        <Icon
                            data-testid="cms-content-details-header-page-options-menu-preview"
                            icon={<PreviewIcon />}
                        />
                    </ListItemGraphic>
                    View
            ...
            {getPlugins<PbPageDetailsHeaderRightOptionsMenuItemPlugin>(
                "cms-content-details-header-right-options-menu-item"
            ).map(plugin => (
