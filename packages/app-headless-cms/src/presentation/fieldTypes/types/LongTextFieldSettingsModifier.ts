...
class LongTextFieldSettingsModifierImpl implements CmsFieldEditorGroupModifier.Interface {
    ...
    shouldApply(context: ICmsFieldEditorContext) {
        return context.fieldType.type === "long-text";
    }
...
export const LongTextFieldSettingsModifier = CmsFieldEditorGroupModifier.createImplementation({
    implementation: LongTextFieldSettingsModifierImpl,
    dependencies: []
});
