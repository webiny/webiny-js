...
/**
 * Emits the content-entries trail (`Headless CMS › <Model> › <folder path>`) through the
 * React Config API. Model and folder path come from the scoped presenter, so this is a plain
