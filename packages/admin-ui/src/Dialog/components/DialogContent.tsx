...
const dialogContentVariants = cva(
    [
        "fixed left-[50%] top-[50%] border bg-neutral-base shadow-lg focus-visible:outline-none rounded-xl text-md text-neutral-strong overflow-y-scroll max-h-screen",
        ...
        "max-w-[calc(100vw-theme(spacing.lg))] max-h-[calc(100vh-theme(spacing.lg))]"
    ],
    {
        variants: {
            size: {
