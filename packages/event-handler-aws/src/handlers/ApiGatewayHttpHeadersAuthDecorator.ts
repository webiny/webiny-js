...
class ApiGatewayHttpHeadersAuthDecoratorImpl implements ApiGatewayEventHandler.Interface {
    constructor(
...
export const ApiGatewayHttpHeadersAuthDecorator = ApiGatewayEventHandler.createDecorator({
    decorator: ApiGatewayHttpHeadersAuthDecoratorImpl,
