...
export { default as Roles2EntitiesTable } from "../../entities/Roles2Entities.mysql";
export { default as SettingsTable } from "../../entities/Settings.mysql";
export { default as UserTable } from "../../entities/User.mysql";
