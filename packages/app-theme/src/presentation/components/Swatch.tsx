...
/**
 * An inline colour chip. Since preview is not shipping in v1, these swatches and the type specimen
...
export const Swatch = ({ color, size = "md", className }: SwatchProps) => {
    return (
        <span
            className={cn(
                "flex-none rounded-sm border border-neutral-dimmed-darker",
