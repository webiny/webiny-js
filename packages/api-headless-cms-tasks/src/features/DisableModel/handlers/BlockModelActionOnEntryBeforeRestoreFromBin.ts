...
class BlockModelActionOnEntryBeforeRestoreFromBinImpl implements EntryBeforeRestoreFromBinHandler.Interface {
...
export const BlockModelActionOnEntryBeforeRestoreFromBin = EntryBeforeRestoreFromBinHandler.createImplementation({
