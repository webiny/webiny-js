import type { IConverter } from "~/abstractions/Converter.js";
import type { IAuditLog } from "@webiny/api-audit-logs/storage/types.js";
import type { IStorageItem } from "~/types.js";
import type { IAccessPatternHandler } from "~/abstractions/AccessPatternHandler.js";
import { convertExpiresAtToUnixTimestamp } from "@webiny/api-audit-logs/utils/expiresAt.js";
