...
export interface IWbSchedulerControllersParams {
    itemsRepository: IWbSchedulerItemsRepository;
    selectedRepository: ISelectedItemsRepository;
    sortingRepository: ISortingRepository;
    searchRepository: ISearchRepository;
}

export interface IWbSchedulerControllersResponse {
...
export class WbSchedulerControllers {
    private readonly itemsRepository: IWbSchedulerItemsRepository;
    ...
    constructor(params: IWbSchedulerControllersParams) {
    ...
    public getControllers(): IWbSchedulerControllersResponse {
        ...
        // Cancel/Publish/Unpublish UseCases
