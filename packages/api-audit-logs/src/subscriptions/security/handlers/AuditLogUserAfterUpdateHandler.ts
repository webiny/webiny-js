...
class AuditLogUserAfterUpdateHandlerImpl implements UserAfterUpdateHandler.Interface {
...
export const AuditLogUserAfterUpdateHandler = UserAfterUpdateHandler.createImplementation({
