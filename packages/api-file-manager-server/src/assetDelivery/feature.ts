...
import { LocalStoragePath, LocalAssetDeliveryConfig } from "./abstractions.js";
...
export const createLocalAssetDeliveryFeature = (params: AssetDeliveryParams = {}) => {
    return createFeature({
        ...
        register(container) {
            container.registerInstance(LocalStoragePath, process.env.LOCAL_STORAGE_PATH as string);
