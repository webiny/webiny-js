...
const MailchimpElementAdvancedSettings = ({ theme, Bind }: Object) => {
    return (
        <React.Fragment>
            <Grid>
                <Cell span={12}>
                        ...
                        {({ onChange, value }) => {
                            return (
                                <AutoComplete
                                    ...
                                    textProp="title"
                                    valueProp="name"
                                    options={theme.elements.mailchimp.components.map(
                                        ({ name, title }) => {
                                            return { name, title };
                                        }
                                    )}
...
export default withTheme()(MailchimpElementAdvancedSettings);
