export default {
    ...
    content: {
        data: {
            settings: {
                width: { value: "1000px" },
                margin: { advanced: true, desktop: { top: 50, bottom: 50 } }
            }
        },
        elements: [
            {
                ...
                elements: [
                    {
                        data: {
                            width: 100,
                            settings: { padding: { desktop: { all: 15 }, mobile: { all: 15 } } }
                        },
                        elements: [
                            {
                                data: {
            ...
            },
            {
                data: {
                    settings: {
                        margin: { advanced: true, desktop: { top: 25 }, mobile: { top: 15 } },
                        padding: { desktop: { all: 15 }, mobile: { all: 15 } }
                    }
                },
                elements: [
                            ...
                            },
                            {
                                data: {
                                    ...
                                    settings: {
                                        ...
                                        margin: { advanced: true, desktop: { left: 20 } }
                                    }
                                },
                                elements: [],
                        ...
                        elements: [
                            {
                                data: {
                                    image: {
                                        name: "sitting-1_l4ijq87wlrw.svg",
                                        type: "image/svg+xml",
                                        size: 9851,
                                        src:
                                            "http://localhost:9000/files/sitting-1_l4ijq87wlrw.svg",
                                        width: "300",
                                        title: "",
                                        alt: "",
                                        height: "",
    ...
    preview: {
        name: "cms-element-5c27aa25a0b03cca9d24a68b_140sjq9q06nh.png",
        size: 71297,
        src: "http://localhost:9000/files/cms-element-5c27aa25a0b03cca9d24a68b_140sjq9q06nh.png",
        type: "image/png",
        width: 1000,
        height: 496
    },
