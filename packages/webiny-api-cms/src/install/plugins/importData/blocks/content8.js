                ...
                elements: [
                    ...
                    },
                    {
                        data: {
                            width: 50,
                            settings: {
                                margin: { advanced: true, desktop: { left: 50, right: 0 } },
                                padding: { desktop: { all: 0 }, mobile: { all: 0 } },
                                verticalAlign: "center"
                            }
                        },
                                ...
                                elements: [
                                    {
                                        data: {
                                            width: 50,
                                            settings: {
                                                margin: { advanced: true, desktop: { right: 15 } },
                                                padding: { desktop: { all: 0 }, mobile: { all: 0 } }
                                            }
                                        },
                                        elements: [
                                                                            ...
                                                                            leaves: [
                                                                                {
                                                                                    object: "leaf",
                                                                                    text:
                                                                                        "Your business, and pay a lot less for an external IT professional to help you when you need it.",
                                                                                    marks: []
                                                                                }
                                                                            ]
                                                                        }
                                    ...
                                    },
                                    {
                                        data: {
                                            width: 50,
                                            settings: {
                                                margin: { advanced: true, desktop: { left: 15 } },
                                                padding: { desktop: { all: 0 }, mobile: { all: 0 } }
                                            }
                                        },
                                        elements: [
                                                                            ...
                                                                            leaves: [
                                                                                {
                                                                                    object: "leaf",
                                                                                    text:
                                                                                        "According to the research firm Frost & Sullivan, the estimated size of the North American used test",
                                                                                    marks: []
                                                                                }
                                                                            ]
                                                                        }
