...
/**
 * Build a Knex client backed by a local SQLite file (better-sqlite3) for the standalone server
 * hosting type. This is the default standalone storage connection; a real deployment can instead pass its
