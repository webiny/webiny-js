...
/**
 * Configure the standalone hosting type's own public API origin.
 *
 ...
 *
 * AWS derives this from stack output (CloudFront domain) at deploy time; the standalone hosting type has
...
export const ApiUrl = defineExtension({
    ...
    description: "Configure the standalone hosting type's own public API origin.",
