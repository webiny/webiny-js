...
import { getStandaloneTemplatesFolderPath } from "../utils/getStandaloneTemplatesFolderPath.js";

/**
 * Standalone hosting-type counterpart to project-aws's BuildProjectWorkspace: after the base workspace is
 ...
 */
class BuildStandaloneProjectWorkspaceImpl implements BuildProjectWorkspaceService.Interface {
    constructor(
...
export const BuildStandaloneProjectWorkspace = BuildProjectWorkspaceService.createDecorator({
    decorator: BuildStandaloneProjectWorkspaceImpl,
