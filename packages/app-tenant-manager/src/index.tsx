...
const TenantIndicator = (LocaleSelector: React.VFC): React.VFC => {
...
const TenantManagerExtension: React.VFC = () => {
...
export const TenantManager: React.VFC = memo(TenantManagerExtension);
