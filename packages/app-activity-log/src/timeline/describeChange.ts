import { describePath, humaniseFieldId, splitPathSegments } from "@webiny/common-activity-log";
 ...
 *
 * The path derivation is shared with the API side through `@webiny/common-activity-log`, so the
 * timeline and the summary prompt name a field the same way. Two implementations would drift, and
