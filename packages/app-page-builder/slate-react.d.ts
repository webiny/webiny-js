...
export interface Plugin {
    ...
    onDragEnter?: (event: Event, change: Change, editor?: Editor) => Change | void;
    onDragExit?: (event: Event, change: Change, editor?: Editor) => Change | void;
    onDragLeave?: (event: Event, change: Change, editor?: Editor) => Change | void;
    onDragOver?: (event: Event, change: Change, editor?: Editor) => Change | void;
    onDragStart?: (event: Event, change: Change, editor?: Editor) => Change | void;
