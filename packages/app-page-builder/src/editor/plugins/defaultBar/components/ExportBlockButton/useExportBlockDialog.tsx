...
const ExportBlockLoadingDialogMessage: React.VFC<ExportBlockLoadingDialogProps> = props => {
...
const ExportBlockDialogMessage: React.VFC<ExportBlockDialogProps> = ({ exportUrl }) => {
