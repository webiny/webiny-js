...
const ExportTemplateLoadingDialogMessage: React.VFC<ExportTemplatesDialogProps> = props => {
...
const ExportTemplateDialogMessage: React.VFC<ExportTemplateDialogProps> = ({ exportUrl }) => {
