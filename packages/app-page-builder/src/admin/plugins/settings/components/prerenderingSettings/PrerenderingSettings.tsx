                                    ...
                                    <Cell span={12}>
                                        ...
                                        >
                                            <Input
                                                ...
                                                description={
                                                    <span>
                                                        The URL to access your app, which is used
                                                        for prerendering.&nbsp;
                                                        {appUrl && (
                                                            <>
                                                                If not specified, the default one (
                                                                <a href={appUrl}>{appUrl}</a>) is
                                                                used.
                                                            </>
                                                        )}
                                                    </span>
                                    ...
                                    <Cell span={12}>
                                        <Bind name={"prerendering.storage.name"}>
                                            <Input
                                                ...
                                                description={
                                                    <span>
                                                        The name of the cloud resource (bucket)
                                                        where the prerendered pages and other
                                                        related assets are stored.&nbsp;
                                                        {storageName && (
                                                            <>
                                                                If not specified, the default one (
                                                                <strong>{storageName}</strong>) is
                                                                used.
                                                            </>
                                                        )}
                                                    </span>
