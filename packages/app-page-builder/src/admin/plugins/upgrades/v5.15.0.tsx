                ...
                <Grid>
                    <Cell span={12}>
                        <Typography use={"body1"} tag={"div"}>
                            ...
                            <ul>
                                <li>insert tenant and locale data into categories</li>
                                <li>insert tenant and locale data into menus</li>
                                <li>insert tenant and locale data into page elements</li>
                            </ul>
                        </Typography>
                    </Cell>
                </Grid>
