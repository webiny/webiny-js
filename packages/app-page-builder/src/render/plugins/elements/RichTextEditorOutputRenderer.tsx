...
const render = (data: OutputBlockData[]) => {
...
type RichTextEditorOutputRendererPropsType = {
    data?: OutputBlockData[] | unknown;
};
const RichTextEditorOutputRenderer: React.FunctionComponent<RichTextEditorOutputRendererPropsType> = ({
    data
}) => {
...
export default React.memo(RichTextEditorOutputRenderer);
