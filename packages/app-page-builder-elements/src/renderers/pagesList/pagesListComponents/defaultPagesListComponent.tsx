...
const PagesListItem: React.VFC<PageItemProps> = ({ data, LinkComponent }) => {
...
const SkeletonPagesListItem: React.VFC = () => {
    return (
        <pb-pages-list-default-list-li>
            <pb-pages-list-default-list-li-img style={{ backgroundColor: "lightgray" }} />
            <pb-pages-list-default-list-li-info>
...
const PbPagesListDefault: React.VFC<PbPagesListDefaultProps> = ({ className, style, children }) => (
