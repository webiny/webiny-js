...
import { ActivitySourceResolver, EntryActivityRecorder } from "~/api/cms/recorder/abstractions.js";
...
} from "~/api/ActivityLogAppFeature.js";
import { ActivitySummaryConfig } from "~/api/cms/summary/config.js";
...
describe("guard 4 — no required dependency outside the platform contract", () => {
    const SRC = join(import.meta.dirname, "../../../src/api");
