...
const ConcentricCircle: React.VFC<CircleProps> = ({
...
const StepStatusIcon: React.VFC<StepStatusIconProps> = ({ status }) => {
...
export const ContentReviewStep: React.VFC<ContentReviewStepProps> = props => {
