...
export const withNewDataList = (withDataListParams: Object): Function => {
        ...
        return compose(
                ...
                options: props => {
                    return {
                        variables: {
                            ...
                            ...prepareNewLoadListParams(props.router)
                        }
                    };
                }
            }),
            withProps(props => {
                ...
                const dataListProps: Object = {
                    ...
                    __loadParams: prepareNewLoadListParams(props.router)
                };
