 ...
 *
 * The composition root lives in @webiny/api-event-handler-aws-ddb-os (`createWebinyApiHandler`) so the
 ...
 */
import { createWebinyApiHandler } from "@webiny/api-event-handler-aws-ddb-os";
